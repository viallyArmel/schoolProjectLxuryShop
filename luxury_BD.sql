CREATE DATABASE IF NOT EXISTS luxurydb;
USE luxurydb;
...
INSERT INTO customer (username, `password`, firstname, lastname, email, phone_number, birthdate, gender, street, postal_code, locality, country, authorities, account_non_expired, account_non_locked, credentials_non_expired, enabled) VALUES
('vially418', '$2a$10$UbEElbK3yjGwTz2afspINeDLxfMxpPfGOS1hwARxvdV.HSwJI5tzW', 'Armel vially', 'Dongmo', 'armelvially418@icloud.com', '0492473290', str_to_date('2009-10-10', '%Y-%m-%d'), 'Homme', 'rue lucien namêche 39', 5000, 'namur', 'belgique', 'ADMIN', 1, 1, 1, 1),
('idrl', '$2a$10$g2kEx49tIx7H4l49C9D88.brN0DipQMZE3hVcmr79EhC4DE75XqZa', 'idricelle', 'tegomo', 'tegomo@gmail.com', '+493993030009988', str_to_date('2009-10-10', '%Y-%m-%d'), 'Femme', 'rue lucien namêche 39', 5000, 'namur', 'belgique', 'USER', 1, 1, 1, 1),
('po_manil', '$2a$10$l.S5S.0Eq8Bk5Tc8LawJr.Hgkd/5dZKuU5mXKsmLZnmk687wI57a6', 'Pierre-Olivier', 'manil', 'pomanil@icloud.com', '0492473290', str_to_date('2009-10-10', '%Y-%m-%d'), 'Homme', 'rue lucien namêche 39', 5000, 'namur', 'belgique', 'ADMIN', 1, 1, 1, 1);
...
INSERT INTO translation (`label`, `category`, `language`) VALUES
('Ensemble vêtements homme', 1, 'fr'),
('Man set outfit', 1, 'en'),
('Chaussures homme', 2, 'fr'),
('Men shoes', 2, 'en'),
('Sacs femme', 3, 'fr'),
('Woman bags', 3, 'en'),
('Ensemble sacs et chaussures femme', 3, 'fr'),
...
INSERT INTO product (`name`, `price`, `picture`, `out_of_stock`, `category`) VALUES
('man set outfit 1', '45', '/images/manSetOutfit/manSetOutfit1', true, 1),

...
<html>
    ...
    <body>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <a href="<spring:url value='/products/all'/>" class="btn btn-main">Shop Now</a>
        ...
        <!-- category -->
        <section class="container-fluid">
            <h2 class="titleMenu"> Catégories </h2>
            <div class="container">
                <c:set var="path" value="/images/category/"/>
                <c:set var="extension" value=".jpeg"/>

                <div class="row row-cols-3">
                    <c:forEach items="${categoryNames}" var="categ" varStatus="status">
                        <div class="col product-thumb sepia">
                            <div>
                                <a href="<spring:url value="/products/category/${status.count}"/>"><img class="img-responsive" title="${categ}" src="<spring:url value='${path}${categ}${extension}' />" alt="category image" /></a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
    ...
    <div class="container-fluid">
        <h2 class="titleMenu">Best sellers</h2>
